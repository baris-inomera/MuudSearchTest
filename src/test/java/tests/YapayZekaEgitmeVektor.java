...
/**
 * YapayZekaEgitme'nin aynı case'lerini Vector indeksinde (ID=49, muud_song_vector_v4) koşturur.
 * Orijinal sınıfa dokunulmaz; bu sınıf sadece hedef indeksi değiştirir.
 *
 * Kullanım:
 *   mvn test -Dtest=YapayZekaEgitmeVektor
 *   Çıktı: proje kök dizininde VektorTestReport_YYYYMMDD_HHmmss.xlsx
 */
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
public class YapayZekaEgitmeVektor extends TestConfig {

    private static final int    TOP_N      = 10;
    private static final String VEKTOR_INDEX = "49"; // muud_song_vector_v4
    ...
    static void init() {
        ...
        System.out.println("✅ YapayZekaEgitmeVektor başlatıldı — index=" + VEKTOR_INDEX + ", top-" + TOP_N + " değerlendirilecek.");
    }
    ...
    // =========================================================================
    // CASE TANIMLAMASI — YapayZekaEgitme ile birebir aynı
    // =========================================================================

...
public class MainCases extends TestConfig {
    ...
    static Stream<BulguCase> cases() {
        ...
        return Stream.of(
                ...
                new BulguCase("sena_1", "iyiki doğdun deniz", "", "iyi ki doğdun deniz", S_SARKI_LYRICS, 3),
                new BulguCase("sena_2", "alara doğum günün", "", "doğum günün kutlu olsun alara", S_SARKI_LYRICS, 3),
                new BulguCase("sena_3", "kürtçe", "", "kürtçe", S_SARKI_LYRICS, 3),
                new BulguCase("sena_4", "taki seni görene kadar", "", "ta ki seni görene kadar", S_SARKI_LYRICS, 3),
                new BulguCase("sena_5", "can dostym", "", "can dostum", S_SARKI_LYRICS, 3),
                new BulguCase("sena_6", "manisa", "", "manisa", S_SARKI_LYRICS, 3),
                new BulguCase("sena_7",   "saygı1",                      "",   "saygı 1",                      S_SARKI_LYRICS, 3),
                new BulguCase("sena_8",   "mebrure",                      "",   "mebrure",                      S_SARKI_LYRICS, 3),
                new BulguCase("sena_9",   "köksal",                      "",   "köksal",                      S_SARKI_LYRICS, 3)
                );
    }
